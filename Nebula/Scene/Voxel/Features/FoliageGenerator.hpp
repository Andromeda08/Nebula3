...
namespace vxl
{
    ...
    private:
        ...
        [[nodiscard]] std::vector<Foliage> generateFoliagePatch(const glm::ivec2& center, const uint32_t r, const uint32_t patchIndex) const noexcept
        {
            std::vector<Foliage> result;
        ...
        void placeFoliagePiece(std::vector<Foliage>& result, const glm::ivec2& pos, const uint32_t patchIndex, const float patchDensity) const noexcept
        {
